  ...
  return (
    <div className="max-w-[1321px] mx-auto px-4 py-8 flex flex-col justify-center items-center ">
          <div className="bg-white p-6 rounded-lg shadow-lg shadow-gray-600">
            <button onClick={handleCheckout} className="bg-green-500 text-white w-full p-2 mt-4 rounded-md">
              Member Checkout
            </button>
        </div>

       {/* Shipment Details */}
      {checkoutStatus && <p className="text-green-600 mt-4 text-center text-3xl font-semibold">{checkoutStatus}</p>}
      {shipmentDetails && (
